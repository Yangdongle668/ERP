...
export default defineModule({
  ...
  menus: [
    ...
    { path: 'workflow', title: '审批流', permission: 'system:workflow:query', doc: '08-审批流.md', component: () => import('./views/WorkflowConfig.vue') },
    { path: 'workflow-instance', title: '审批监控', permission: 'system:workflow:monitor', doc: '08-审批流.md', component: () => import('./views/WorkflowInstanceList.vue') },
    { path: 'print-template', title: '打印模板', permission: 'system:print:query', doc: '09-打印模板.md', component: () => import('./views/PrintTemplateList.vue') },
    { path: 'print-template/new', title: '新建打印模板', permission: 'system:print:create', hidden: true, doc: '09-打印模板.md', component: () => import('./views/PrintTemplateEdit.vue') },
    { path: 'print-template/:id/edit', title: '编辑打印模板', permission: 'system:print:query', hidden: true, doc: '09-打印模板.md', component: () => import('./views/PrintTemplateEdit.vue') },
