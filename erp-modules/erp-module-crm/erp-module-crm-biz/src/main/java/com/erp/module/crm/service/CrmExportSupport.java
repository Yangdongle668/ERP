 ...
 */
@Component
public class CrmExportSupport {

    private final ParamApi paramApi;
    private final AsyncTaskApi asyncTaskApi;

    public CrmExportSupport(ParamApi paramApi, AsyncTaskApi asyncTaskApi) {
    ...
    public <T> void export(HttpServletResponse response, String name, List<ExcelColumn<T>> excelColumns, String columns,
        ...
        Long taskId = asyncTaskApi.submit(AsyncTaskApi.TYPE_EXPORT, "导出" + name, CrmModuleConfig.MODULE, ctx -> {
